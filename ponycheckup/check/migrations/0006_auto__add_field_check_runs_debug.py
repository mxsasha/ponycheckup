...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Check.runs_debug'
        db.add_column('check_check', 'runs_debug',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Check.runs_debug'
        db.delete_column('check_check', 'runs_debug')
    ...
    models = {
        'check.check': {
            ...
            'runs_debug': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
